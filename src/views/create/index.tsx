                                ...
                                <div className='pb-6 my-auto'>
                                    ...
                                    <div className='text-start'>
                                        ...
                                        <div className='mb-6 text-center'>
                                            ...
                                            className='bg-primary-600/90 hover:bg-primary-600 group mt-5 inline-flex w-full items-center rounded-lg px-6 py-2 text-white backdrop-blur-2xl transition-all duration-500'
                                            type='submit'
                                            >
