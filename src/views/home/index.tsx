          ...
          <div className="container">
            <div className="p-6">
              <div className="relative grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
                <div className="bg-primary/10 -z-1 start-0 absolute top-0 h-14 w-14 animate-[spin_10s_linear_infinitel] rounded-2xl rounded-br-none rounded-tl-none"
                ></div>
                ...
                <div className="mx-auto h-[595px] overflow-hidden">
                  <div className="marquee grid grid-cols-2 gap-6">
                    ...
                    <div className="marquee-reverse m-auto flex flex-col gap-6 overflow-hidden">
                        ...
                        className="marquee-hero flex min-h-full flex-shrink-0 flex-col items-centr justify-around gap-6">
                          {
                          ["img-9", "img-14", "img-21", "img-22", "img-10"].map(
                            (image, index) => (
                              <img 
