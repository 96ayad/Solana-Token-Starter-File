        ...
        <div className="mx-auto max-w-3xl">
          <div className="hs-accordion-group space-y-4">
            {questions.map((question, index) => (
              ...
              id={question.id}
              >
                <button className="hs-accordion-toggle inline-flex items-center justify-between gap-x-3 px-6 py-4 text-left capitalize text-white transition-all"
                ...
                >
                  <div className="px-6 pb-4 pt-0">
                    ...
                    <p className="text-default-300 text-sm font-medium">
                      Have you ever wanted to be blockchain developer check the pro NFT Marketplace Course
                    </p>
                  </div>
                </div>
              </div>
